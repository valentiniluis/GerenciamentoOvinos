    ...
    <div className="row">
      ...
      <main className="col cont">
        ...
        <form className="row" action="/cadastrarOvelha" method="POST">
          <h4>Informações</h4>
          { campos.map(campo => {
            return (<InputField name={campo.name} nameSize={campo.nameSize} inputSize={campo.inputSize} />);
          })}
          <div className='row py-5 justify-content-center'>
            <Button className='form-btn' variant='primary' type='submit'>Cadastrar</Button>
          </div>
        </form>
      </main>
    </div>
